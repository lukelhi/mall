...
//		List<Item> list = itemMapper.selecyExample(example);
//		//取分页的信息
//		//Item跟jsp中的field对应
...
//
//	@Override
//	public TaotaoResult createItem(Item item, String desc,String itemParam) {
//
//		//生成商品id
...
//		//执行查询
//		List<ItemParamItem> list = itemParamItemMapper.selecyExampleWithBLOBs(example);//按条件查询到参数
//
