	...
	<div id="service-2013">
		...
		<dl class="fore2">		
			...
			<dd>
				...
				<div><a href=" " rel="nofollow">如何配送</a></div>
		...
		<dl class="fore5">
			...
			<dd>		
				...
				<div><a href="" rel="nofollow">商城通信</a></div>
			</dd>
		</dl>
		<div class="fr">
			<div class="sm" id="branch-office">
				...
				<div class="smc">
					<p>商城品种齐全、价格合理。 在消费者当中享有较高的地位，公司与多家零售商和代理商建立了 长期稳定的合作关系。</p>
				</div>
			</div>
		</div>
		<span class="clr"></span>
